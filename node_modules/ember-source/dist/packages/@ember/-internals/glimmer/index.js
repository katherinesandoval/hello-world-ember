...
const mountHelper = internalHelper((args, vm) => {
  ...
  if (args.named.has('model')) {
    assert('[BUG] this should already be checked by the template transform', args.named.length === 1);
...
const outletHelper = internalHelper((args, vm) => {
  ...
  return createComputeRef(() => {
    ...
    if (!validate(state, lastState)) {
      ...
      if (state !== null) {
        ...
        let owner = (_b = (_a = outletState === null || outletState === void 0 ? void 0 : outletState.render) === null || _a === void 0 ? void 0 : _a.owner) !== null && _b !== void 0 ? _b : vm.getOwner();
        let args = createCapturedArgs(named, EMPTY_POSITIONAL);
        definition = curry(0
        /* Component */
        , new OutletComponentDefinition(state), owner, args, true);
      } else {
        definition = null;
      }
    }
